...
=== Updated file structure and build process

- Reformat schema structure, including historical releases
- Remove scripting dependencies when generating docs
- Correct asciidoc syntax
- Parameterize needed asciidoc variables, load in .env file
- Generate standalone changelog
- Create build process, automate
- Clean dangling, unreferenced or composite files
