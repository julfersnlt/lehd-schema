...
|===================================================
type,Description all,"Collection of all available states" us,"National data (50 states + DC)" metro,Indicates collection of CBSA-level files (*directory names only*)
