...
|===================================================
Scope,Types,Format file US,N,link:label_geography_us.csv[]
...
For instance, the metadata for the latest_release QWI release of Delaware (obtained from https://lehd.ces.census.gov/data/qwi/latest_release/de/version_qwi.txt[here]) has the following content:
...
Similarly, the metadata for the latest release of Delaware J2J tabulations (obtained from https://lehd.ces.census.gov/data/j2j/latest_release/de/j2j/version_j2j.txt[here]) has the following content:
...
An example for Colorado institutions has the following content:
