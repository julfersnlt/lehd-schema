...
|===================================================
include::/data/users/lehdadm/lehd-schema/formats/V4.8.2/tmp.UlQcXPIFqg[]
|===================================================
<<<
...
[width="95%",format="csv",cols="<1,<3,<5,2*<1",options="header"]
|===================================================
include::/data/users/lehdadm/lehd-schema/formats/V4.8.2/tmp.3rqLEAqFzJ[]
|===================================================
<<<
...
`grad_cohort` is a 4-digit number representing the first year of the graduation cohort. The number of years in the
cohort is reported in the separate <<Grad Cohort Years>> variable.
...
==== Geographic Levels
Geography labels for data files are provided in separate files, by scope.Each file 'label_geography_SCOPE.csv' may
contain one or more types of records as flagged by <<Geographic Levels,geo_level>>.For convenience, a composite file containing all
geocodes is available as link:label_geography.csv[].
...
|===================================================
include::/data/users/lehdadm/lehd-schema/formats/V4.8.2/tmp.eG0fbw7i2H[]
|===================================================
...
for all entities of <<Geographic Levels,geo_level>> 'N' or 'S', and is a summary of separately available files.
...
for all entities of <<Geographic Levels,geo_level>> 'D'. For more information on which states comprise each division, see the map
...
|===================================================
include::/data/users/lehdadm/lehd-schema/formats/V4.8.2/tmp.PqakCbPMv4[]
|===================================================


==== [[geosubstate]]Detailed State and Substate Level Values

Files of type 'label_geography_[ST].csv' will contain identifiers and labels for geographic areas entirely comprised
within a given state '[ST]'. State-specific parts of cross-state CBSA, in records of type <<Geographic Levels,geo_level>> = M, are
present on files of type 'label_geography_[ST].csv'. The file link:label_geography_metro.csv[] contains labels for
records of type <<Geographic Levels,geo_level>> = B, for metropolitan areas only.
...
|===================================================
include::/data/users/lehdadm/lehd-schema/formats/V4.8.2/tmp.zAMRsNeMa0[]
|===================================================
...
|===================================================
include::/data/users/lehdadm/lehd-schema/formats/V4.8.2/tmp.aPDonLDLzU[]
|===================================================
...
--------------------------------
Similarly, the metadata for the latest release of
Delaware J2J
...
The PSEO metadata will contain separate lines for the PSEOE and PSEOF tables. The year range for PSEO tables is based
on the <<Grad Cohort>>, the start year of the graduation cohort. An example for Colorado institutions has the following
content:
...
|===================================================
The reference region will always be either the origin or the destination. National tabulations contain records where
both origin and destination are <<Geographic Levels,geo_level>>=N; state tabulations contain records where <<Geographic Levels,geo_level>> in
(N,S); metro tabulations contain records where <<Geographic Levels,geo_level>> in (N,S,B). Data may be suppressed for certain
combinations of regions and quarters because the estimates do not meet Census Bureau publication standards.
